...
==Description==
<strong>About pickrr</strong>
<p>pickrr is India’s leading eCommerce shipping solution. It is packed with various features that help you in shipping across 26000+ pin codes in India and 220+ countries across the globe. With the pickrr-Woocommerce plugin, you can easily handle all your order fulfillment processes such as inventory management and shipping at one place.</p>
<p>With this FREE shipping plugin, you can ship at discounted rates starting from Rs. 23/500g. Also, you can choose from 17+ courier partners that include leading names such as FedEx, Delhivery, Bluedart, Wefast and Shadowfax. Sync your Woocommerce account with pickrr using our plugin and simplify your eCommerce shipping! 
Here are a few more features you get in the pickrr panel.</p>
...
<p>Know more about pickrr here - <a href="https://www.pickrr.in/features/"><strong>Features</strong></a> | <a href="https://www.pickrr.in/pricing/"><strong>Pricing</strong></a> | <a href="https://www.pickrr.in/how-do-i-integrate-woocommerce-with-pickrr/"><strong>FAQ's</strong></a> | <a href="https://www.pickrr.in/contact/"><strong>Contact Us</strong></a></p>

<p><b>How to integrate your Woocommerce store with pickrr?</b></p>
...
<p>
1. For a non-registered user, please begin by entering your email ID. You can use the same email ID to log in to your pickrr panel. For registered user, please enter your registered pickrr email ID.
2. Company Name
3. First Name
4. Last name
5. Registered Mobile Number
6. Post entering all the details, the user has to click on the button “Signup on pickrr and Get API Keys”.
7. If the user is already present, the app will map your existing pickrr account. If not, the app will create a new pickrr Account.
8. User has to enter the Shipping Method title which will be displayed on the Checkout Page
9. It is mandatory to enter the fallback shipping charges which can be applied in case none of pickrr couriers are serviceable.
...
<strong>USING THE pickrr PANEL</strong>
<p>1. Login to the pickrr panel.
...
7. The Green Icon indicates that the channel has been successfully configured. Congratulations. You successfully integrated your Woocommerce Store with pickrr.<br>
</p>

<strong>APP FEATURES</strong>
<p>
1. Seamless Signup on pickrr
2. Integrate your existing pickrr using Single Sign On (SSO)
3. Show your customers multiple courier partners with their estimated delivery time, rate, and mode on the checkout page. 
4. Available on all pickrr Plans
5. Displays custom EDD on Product Description Page based on the courier priority you have set on your pickrr panel.
...
7. Display fallback ‘flat rates’ if in case none of the pickrr couriers are serviceable.
</p>
...
<p><strong>3. Catalog & inventory Sync</strong> – All the active products on the Woocommerce panel will automatically be fetched into the system, and correspondingly the stock count for products on Woocommerce can be managed from pickrr Panel.<br></p>
...
3. Go to WooCommerce > settings > Shipping > pickrr App  Configuration.
...
* Add - ***Buyer selected Courier*** can be seen while shipping the order in pickrr
...
* Add - ***SignUp and link pickrr*** account with WooCommerce
