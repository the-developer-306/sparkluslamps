        ...
        <div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"140px","bottom":"140px","left":"0","right":"0"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
            <div class="wp-block-group" style="padding-top:140px;padding-right:0;padding-bottom:140px;padding-left:0"><!-- wp:columns -->
                <div class="wp-block-columns"><!-- wp:column {"width":"50%"} -->
                    <div class="wp-block-column" style="flex-basis:50%"><!-- wp:heading {"textAlign":"left","level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1.3"},"color":{"text":"#fbfbfb"}},"fontSize":"xxx-large"} -->
                        <h1 class="wp-block-heading has-text-align-left has-text-color has-xxx-large-font-size" style="color:#fbfbfb;font-style:normal;font-weight:600;line-height:1.3"><?php esc_html_e('Your Shopping Destination Awaits: Start Exploring!', 'shopcity') ?></h1>
                        <!-- /wp:heading -->
